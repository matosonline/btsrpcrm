...
@section('content')
<div class="table-responsive view_leadLog_wrap">
        <table class="table table-striped view_providerLog_table" id="view_leadLog_table">
            <thead>
                <tr>
                    <th>No.</th>
                    <th>UserName</th>
...
@section('pagescript')
<script>
    $('#main_header').html("View Provider Log");
</script>
<script type="text/javascript">
$(function () {
    $('.view_providerLog_table').DataTable({searching: false, paging: true, info: false, lengthChange: false, pageLength: 5, order: false});
});
</script>
