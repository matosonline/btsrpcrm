    ...
    <table class="table table-striped view_userLog_table" id="view_userLog_table" width="100%">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="javascript:void(0);" class="viewLogData" data-log-id="{{$logArray[$key]['id']}}" title="View Log Details" data-log-type='user'>
...
$(function () {
    $('.view_userLog_table').DataTable({searching: false, 
        order: [0,'desc'],
        dom:"<'row'<'col-sm-12'<'table-responsive'tr>>>" +
            "<'row'<'col-12 col-sm-6'><'col-12 col-sm-6'p>>",
